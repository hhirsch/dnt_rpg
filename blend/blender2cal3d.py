	...
	if bone_head.length != 0.0:
		...
		if parent:
			...
			if base_matrix and arm_matrix and not parent:
				...
				interm_quat = result_matrix.toQuat()
			else:
...
#					print "root bone translation: ", root_bone_translation
...
def gui():
	...
	_XML_toggle = Toggle("Export to XML", 2, 8, 84, 300, 20, EXPORT_TO_XML, 
...
def update_reg():
	global SAVE_TO_DIR, DELETE_ALL_FILES, EXPORT_SKELETON,               \
	       ...
	       FPS, LODS, ROT_X, ROT_Y, ROT_Z, SCALE
