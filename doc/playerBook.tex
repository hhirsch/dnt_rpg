...
{\bf Pre-Requisites}: Physical Education Student level 1\\
...
\subsubsection{Shrink Item}
 {\bf Pre-Requisites}: Physical Education Student level 3\\
...
\subsubsection{Virtually Invincible}
 {\bf Pre-Requisites}: Physical Education Student level 7\\
...
{\bf Pre-Requisites}: Physical Education Student level 10\\
...
\subsubsection{Powerfull Esophagus}
 {\bf Pre-Requisites}: Physical Education Student level 15\\
...
\subsubsection{Abominable Mutation}
 {\bf Pre-Requisites}: Physical Education Student level 20\\
