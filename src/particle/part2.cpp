...
part2::part2(float cX,float cY,float cZ):particleSystem(300)
{
   centerX = cX; 
   centerY=cY; 
   centerZ=cZ;
...
void part2::drawSphereToList(double r, int lats, int longs) 
{
...
void part2::actualize(particle* part)
{
   ...
   part->velX += seconds*(20*((rand() / ((double)RAND_MAX + 1))) - 10);
   part->velZ += seconds*(20*((rand() / ((double)RAND_MAX + 1))) - 10);
