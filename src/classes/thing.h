...
class thing
{
   public:
      ...
      std::string onHitSound;    /**< Default sound to when hit */
      std::string onAttackSound; /**< Default sound when attacking without weapons */
      std::string onDeathSound;  /**< Default sound when die */
